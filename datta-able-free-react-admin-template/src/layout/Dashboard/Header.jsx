...
export default function Header() {
  ...
  const employeeName = employee.employee_name || 'Guest';
  ...
  useEffect(() => {
    ...
    speak(`Welcome ${employeeName || "User"} to Chriyodex`);
  }, []);
  ...
  const handleLogout = () => {
    ...
    navigate("/login"); // Or navigate("/login") depending on your route
  };
              ...
              <Dropdown.Menu className="dropdown-user-profile pc-h-dropdown p-0 overflow-hidden">
                <Dropdown.Header className="bg-primary">
                  <Stack direction="horizontal" gap={3} className="my-2">
                    ...
                    <Stack gap={1}>
                       <h6 className="text-white mb-0">{employeeName}🖖</h6>
